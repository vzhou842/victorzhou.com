...
<div id="easy-vqa-demo">
  <iframe src="https://easy-vqa-demo.victorzhou.com" width="100%" height="675px"></iframe>
</div>
...
> Note: this post uses first person ("I", "my") to read like it's me (Victor Zhou) talking. However, as indicated at the top, this post was co-authored by my good friend [Phillip Wang](https://phillipkwang.com/). Thanks Phillip!
...
I won't include the full code in this post itself to save space, but you can **[find it on Github](https://github.com/vzhou842/easy-VQA-keras)** or **[run it directly in your web browser](TODO replit link)**.

Running the code gives us results like this:

```
Epoch 1/5
loss: 0.9005 - accuracy: 0.6460 - val_loss: 0.7287 - val_accuracy: 0.6908
Epoch 2/5
loss: 0.6694 - accuracy: 0.7159 - val_loss: 0.6105 - val_accuracy: 0.7423
Epoch 3/5
loss: 0.5560 - accuracy: 0.7578 - val_loss: 0.5183 - val_accuracy: 0.7649
Epoch 4/5
loss: 0.4797 - accuracy: 0.7737 - val_loss: 0.4716 - val_accuracy: 0.7732
Epoch 5/5
loss: 0.4258 - accuracy: 0.7902 - val_loss: 0.4375 - val_accuracy: 0.7912
```

Not bad for 5 epochs on such a simple model:
- we reached **79%** validation accuracy
...
- Read the original [VQA paper](http://arxiv.org/pdf/1505.00468.pdf) from the 2015 International Conference on Computer Vision ([ICCV 2015](http://pamitc.org/iccv15/)).
