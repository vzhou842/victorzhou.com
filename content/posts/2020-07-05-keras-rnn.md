...
Tensorflow has a very easy way for us to read in our dataset: [text\_dataset\_from\_directory](https://www.tensorflow.org/api_docs/python/tf/keras/preprocessing/text_dataset_from_directory) (yes, this was the reason we needed `tf-nightly`). Here's how we'll do it:
